<template>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg" dir="rtl">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr v-if="data && data.data" v-for="(item, key) in data.data"
                    ...
                    <td class="px-6 py-4">
                        <Link v-for="(action, key) in options.actions" :href="route(action.route, { id: item.id })"
    ...
    data.meta.current_page
        ...
        <div class="inline-flex mt-2 xs:mt-0">
            <!-- Buttons -->
            <Link :href="data.links.prev" v-if="data.links.prev"
            ...
            <Link :href="data.links.next" v-if="data.links.next"
